# A simple parallel (Mandelbrot Set)[[https://en.wikipedia.org](https://en.wikipedia.org/wiki/Mandelbrot_set)] explorer powered by (SIMD)[https://en.wikipedia.org/wiki/SIMD]
